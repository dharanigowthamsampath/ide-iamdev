...
var defaultUrl = localStorageGetItem("api-url") || "http://62.72.31.233:2358/";
  ...
  $.ajax({
    ...
    success: function (data, textStatus, jqXHR) {
      if (data.status.id <= 2) {
        ...
        setTimeout(
          fetchSubmission.bind(null, submission_token, iteration + 1),
...
$(document).ready(function () {
  ...
  $(document).on("keydown", "body", function (e) {
    ...
    if ((e.metaKey || e.ctrlKey) && keyCode === 13) {
...
var executableSource =
  '\
Iamdev IDE assumes that content of executable is Base64 encoded.\n\
\n\
...
var sqliteSource =
  "\
-- On Iamdev IDE your SQL script is run on chinook database (https://www.sqlitetutorial.net/sqlite-sample-database).\n\
-- For more information about how to use SQL with Iamdev please\n\
...
var c3Source =
  '\
// On the Iamdev IDE, C3 is automatically\n\
...
var nimSource =
  '\
# On the Iamdev IDE, Nim is automatically\n\
...
var bosqueSource =
  '\
// On the Iamdev IDE, Bosque (https://github.com/microsoft/BosqueLanguage)\n\
